        ...
        {channels.map((channel) => (
          <li key={channel.id}>
            <Link
              ...
              className={`focus-ring flex items-center gap-3 rounded-lg py-1.5 text-sm font-medium text-fg-muted transition-colors hover:bg-surface-muted hover:text-fg ${
